...
if mdechoseone == 1 or mdechoseone == "01" :
    ...
    if yesorno == 'y' or yesorno == 'yes':
        ...
        os.system("apt-get install libany-uri-escape-perl -y ")
        os.system("apt-get install libhtmal-html5-entites-numbered-perl -y ")
        os.system("apt-get install lbhtmal-parser-perl -y ")
        os.system("apt-get install libwww-perl -y ")        
    ...
    print("#" * 80)
    print("I Cant Help You Try By Your Selfe:>")
    print("#" * 80)
